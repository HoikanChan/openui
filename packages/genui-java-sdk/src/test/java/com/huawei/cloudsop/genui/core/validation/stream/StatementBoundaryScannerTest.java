...
/**
 * Direct coverage of the incremental boundary detection (§6.1). Verifies that statements only surface once definitively
 * terminated, that multi-line / array / ternary / string-with-newline constructs stay a single statement, and that a
 * pending tail is withheld until {@link StatementBoundaryScanner#drainAtEnd()}.
 *
 * @since 2026
 */
