...
/**
 * Renders an inferred {@link ShapeNode} schema tree to a TypeScript-type string, rooted at the name {@code data} so the
 * rendered type reinforces the {@code data.<field>} reference path used elsewhere in the prompt.
 *
 * @since 2026
 */
