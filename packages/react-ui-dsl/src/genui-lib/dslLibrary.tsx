...
export const DEFAULT_PROMPT_ADDITIONAL_RULES = [
  ...
  "An Open Template reference unresolved during streaming is provisional and may resolve when a same-named statement arrives; at completion, every unresolved Open Template reference is a hard error.",
