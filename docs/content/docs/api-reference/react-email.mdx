...
```bash tab="npm"
npm install @openuidev/react-email @cloudsop/openui-react-lang @react-email/render
```

```bash tab="pnpm"
pnpm add @openuidev/react-email @cloudsop/openui-react-lang @react-email/render
```
